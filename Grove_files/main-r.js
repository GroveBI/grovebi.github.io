var reactVersions = {
  ...
  "cloud": "1.735.4",
  "components": "1.735.4",
  "componentsPreviewLayer": "1.735.4",
  "core": "1.735.4",
  "documentServices": "1.735.4",
  "editingRendererPlugins": "1.735.4",
  "fonts": "1.735.4",
  "layout": "1.735.4",
  "previewExtensionsCore": "1.735.4",
  "qaAutomation": "1.735.4",
  "server": "1.735.4",
  "skins": "1.735.4",
  "testUtils": "1.735.4",
  "tpa": "1.735.4",
  "tpaIntegration": "1.735.4",
  "tweenEngine": "1.735.4",
  "utils": "1.735.4",
  "wixSites": "1.735.4",
  "wixappsBuilder": "1.735.4",
  "wixappsClassics": "1.735.4",
  "wixappsCore": "1.735.4"
};
    ...
    siteAsJson.pages.forEach(function(page) {
        ...
        if (pageItem && pageItem.pageBackgrounds && pageItem.pageBackgrounds.desktop.ref) {
            ...
            if (desktopBg) {
                ...
                console.error('movePageDataToMaster: Missing desktop background item %s for page ', pageItem.id);
            }
            ...
            if (mobileBg) {
                ...
                console.error('movePageDataToMaster: Missing mobile background item %s for page ', pageItem.id);
            }
